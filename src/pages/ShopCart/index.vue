<template>
  <div class="cart">
      ...
      <div class="cart-body">
        <ul class="cart-list" v-for="cart in cartInfoList" :key="cart.id">
          ...
          <li class="cart-list-con7">
            <a class="sindelet" @click="deleteCheckedCart(cart)">删除</a>
            <br />
            <a href="#none">移到收藏</a>
          </li>
        </ul>
    ...
    <div class="cart-tool">
      ...
      <div class="option">
        <a @click="updateAllChecked">删除选中的商品</a>
  ...
  methods: {
    ...
    async updateChecked(cart, event) {
      ...
      try {
        ...
        await this.$store.dispatch("getIschecked", {
          skuId: cart.skuId,
          isChecked,
        });
        // console.log(111);
    ...
    async updateAllChecked(){
      ...
      try {
        await this.$store.dispatch('updateAllChecked')
        this.getData()
      } catch (error) {
        alert(error.message)
      }

      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="crumbs in floor.navList" :key="crumbs.id">
              <a href="#tab1" data-toggle="tab">{{ crumbs.text }}</a>
            </li>
          </ul>
        </div>
      </div>
...
export default {
  name: "Floor",
  props: ["floor"],
  // 这里mounted里面写swiper可以的原因是：这次请求的数据没在组件内部发请求，而是在父组件里面，数据是父组件通过props传递过来的，所以此时结构已经有了

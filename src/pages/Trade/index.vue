  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        ...
        收货人：<span>{{ shippingAddress.consignee }}</span>
        <span>{{ shippingAddress.phoneNum }}</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      // reqSubmitOrder: 需要携带参数
      let tradeNo = this.tradeInfo.tradeNo;
      let data = {
        consignee: this.shippingAddress.consignee,
        consigneeTel: this.shippingAddress.phoneNum,
        deliveryAddress: this.shippingAddress.fullAddress,
        paymentWay: "ONLINE",
